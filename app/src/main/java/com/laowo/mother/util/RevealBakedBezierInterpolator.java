...
/**
 * Created by xsh on 2016/8/19.
 */

public class RevealBakedBezierInterpolator implements Interpolator {

    private static final RevealBakedBezierInterpolator INSTANCE = new RevealBakedBezierInterpolator();

    public final static RevealBakedBezierInterpolator getInstance() {
        return INSTANCE;
    }
     ...
     */
    private RevealBakedBezierInterpolator() {
        super();
    }
