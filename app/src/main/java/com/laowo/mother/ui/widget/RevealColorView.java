...
import com.laowo.mother.util.RevealBakedBezierInterpolator;
import com.laowo.mother.util.RevealUiHelper;

public class RevealColorView extends RelativeLayout {
    ...
    public RevealColorView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        RevealUiHelper.setBackground(inkView, circle);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        reveal(x, y, getResources().getColor(R.color.divider_gray), 10, 1000, null);
    ...
    public ViewPropertyAnimator prepareAnimator(ViewPropertyAnimator animator, int type) {
        ...
        animator.setInterpolator(RevealBakedBezierInterpolator.getInstance());
        return animator;
    }
